...
def move_axes(ax, fig, subplot_spec=111):
    """
    Function from gist.github.com/salotz/8b4542d7fe9ea3e2eacc1a2eef2532c5
...
class Background():
    ...
    def __init__(self, fig=None, visible=False, spacing=0.1,
                 linecolor='0.5', linewidth=1):
    ...
    def labels(self, xs, ys, fontsize=18):
        ...
        for x, y, letter in zip(xs, ys, letters):
            self.axes.text(x, y, letter, transform=self.axes.transAxes,
    ...
    def box(self, pos, title=None, titlestyle=None, pad=0.0, **args):
        ...
        fancy = matplotlib.patches.FancyBboxPatch((pos[0], pos[2]),
                                                  width, height,
...
def box_rounded(ax, pos, title=None, pad=0.0):
    ...
    if title:
        plt.text(pos[0]+0.02, pos[3]+pad, title, ha='left',
